...
void copyVec(vector<double> a, vector<double> &b)
{
  b.clear();
  b.reserve(a.size());
...
void getParameters(cmdline::parser & a, Parameters & params)
{
  ...
  Parameters::parseHyperParameters(params.hap3_params.mut_a0, a.get<string>("mutationModelAlpha"));
  Parameters::parseHyperParameters(params.hap3_params.mut_b0, a.get<string>("mutationModelBeta"));
  Parameters::parseHyperParameters(params.hap3_params.mut_c0, a.get<string>("mutationModelGamma"));
  Parameters::parseHyperParameters(params.hap3_params.err_a0, a.get<string>("errorModelAlpha"));
  Parameters::parseHyperParameters(params.hap3_params.err_b0, a.get<string>("errorModelBeta"));
  Parameters::parseHyperParameters(params.hap3_params.err_c0, a.get<string>("errorModelGamma"));
  copyVec(params.hap3_params.mut_a0, params.hap2_params.mut_a0);
  copyVec(params.hap3_params.mut_b0, params.hap2_params.mut_b0);
  copyVec(params.hap3_params.mut_c0, params.hap2_params.mut_c0);
  copyVec(params.hap3_params.err_a0, params.hap2_params.err_a0);
  copyVec(params.hap3_params.err_b0, params.hap2_params.err_b0);
  copyVec(params.hap3_params.err_c0, params.hap2_params.err_c0);
}
...
int main(int argc, char *argv[])
{
  ...
  a.add<string>("mutationModelAlpha", 'h', "hyper parameter for tumor haplotype frequencies in mutation model.", false, "1.0,1.0,1.0");
  a.add<string>("mutationModelBeta", 'i', "hyper parameter for error rates in mutation model.", false, "0.1,10.0");
